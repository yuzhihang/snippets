...
(function() {
    ...
    f.prototype = {
        ...
        setupPositionProbePattern: function(a, d) {
            for (var b = -1; 7 >= b; b++)
                if (!(-1 >= a + b || this.moduleCount <= a + b))
                    for (var c = -1; 7 >= c; c++) - 1 >= d + c || this.moduleCount <= d + c || (0 <= b && 6 >= b && (0 == c || 6 == c) || 0 <= c && 6 >= c && (0 == b || 6 == b) || 2 <= b && 4 >= b && 2 <= c && 4 >= c ? this.modules[a + b][d + c] = !0 : this.modules[a + b][d + c] = !1)
        },
        getBestMaskPattern: function() {
            for (var a = 0, d = 0, b = 0; 8 > b; b++) {
                this.makeImpl(!0, b);
        ...
        setupPositionAdjustPattern: function() {
            for (var a = m.getPatternPosition(this.typeNumber), d = 0; d < a.length; d++)
                for (var b = 0; b < a.length; b++) {
                    var c = a[d],
                        e = a[b];
                    if (null == this.modules[c][e])
                        for (var g = -2; 2 >= g; g++)
                            for (var q = -2; 2 >= q; q++) - 2 == g || 2 == g || -2 == q || 2 == q || 0 == g && 0 == q ? this.modules[c + g][e + q] = !0 : this.modules[c + g][e + q] = !1
                }
        },
        ...
        setupTypeInfo: function(a, d) {
            ...
            for (c = 0; 15 > c; c++) e = !a && 1 == (b >> c & 1), 8 > c ? this.modules[8][this.moduleCount - c - 1] = e : 9 > c ? this.modules[8][15 - c - 1 + 1] = e : this.modules[8][15 - c - 1] = e;
            this.modules[this.moduleCount - 8][8] = !a
        },
        mapData: function(a, d) {
            for (var b = -1, c = this.moduleCount - 1, e = 7, g = 0, q = this.moduleCount - 1; 0 < q; q -= 2)
                for (6 == q && q--;;) {
                    for (var h = 0; 2 > h; h++)
                        if (null == this.modules[c][q - h]) {
                            var u = !1;
    ...
    f.createBytes = function(a, d) {
        for (var b = 0, c = 0, e = 0, g = Array(d.length), q = Array(d.length), h = 0; h < d.length; h++) {
            var u = d[h].dataCount,
                f = d[h].totalCount - u,
                c = Math.max(c, u),
                e = Math.max(e, f);
        ...
        b = Array(h);
        for (n = u = 0; n < c; n++)
            for (h = 0; h < d.length; h++) n < g[h].length && (b[u++] = g[h][n]);
        for (n = 0; n < e; n++)
            for (h = 0; h < d.length; h++) n < q[h].length && (b[u++] = q[h][n]);
        return b
    };
    for (var t = {
            MODE_NUMBER: 1,
            ...
            getBCHTypeNumber: function(a) {
                for (var d = a << 12; 0 <= m.getBCHDigit(d) - m.getBCHDigit(m.G18);) d ^= m.G18 << m.getBCHDigit(d) - m.getBCHDigit(m.G18);
                return a << 12 | d
            },
            ...
            getLostPoint: function(a) {
                for (var d = a.getModuleCount(), b = 0, c = 0; c < d; c++)
                    for (var e = 0; e < d; e++) {
                        for (var g = 0, q = a.isDark(c, e), h = -1; 1 >= h; h++)
                            if (!(0 > c + h || d <= c + h))
                                for (var f = -1; 1 >= f; f++) 0 > e + f || d <= e + f || 0 == h && 0 == f || q != a.isDark(c + h, e + f) || g++;
                        5 < g && (b += 3 + g - 5)
                    }
                for (c = 0; c < d - 1; c++)
                    for (e = 0; e < d - 1; e++)
                        if (g = 0, a.isDark(c, e) && g++, a.isDark(c + 1, e) && g++, a.isDark(c, e + 1) && g++, a.isDark(c + 1, e + 1) && g++, 0 == g || 4 == g) b += 3;
                for (c = 0; c < d; c++)
                    for (e = 0; e < d - 6; e++) a.isDark(c, e) && !a.isDark(c, e + 1) && a.isDark(c, e + 2) && a.isDark(c, e + 3) && a.isDark(c, e + 4) && !a.isDark(c, e + 5) && a.isDark(c, e + 6) && (b += 40);
                for (e = 0; e < d; e++)
                    for (c = 0; c < d - 6; c++) a.isDark(c, e) && !a.isDark(c + 1, e) && a.isDark(c + 2, e) && a.isDark(c + 3, e) && a.isDark(c + 4, e) && !a.isDark(c + 5, e) && a.isDark(c + 6, e) && (b += 40);
                for (e = g = 0; e < d; e++)
                    for (c = 0; c < d; c++) a.isDark(c, e) && g++;
    ...
    k.prototype = {
        ...
        multiply: function(a) {
            for (var d = Array(this.getLength() + a.getLength() - 1), b = 0; b < this.getLength(); b++)
                for (var c = 0; c < a.getLength(); c++) d[b + c] ^= p.gexp(p.glog(this.get(b)) + p.glog(a.get(c)));
            return new k(d, 0)
        },
        mod: function(a) {
    ...
    v.getRSBlocks = function(a, d) {
        ...
        for (var c = b.length / 3, e = [], g = 0; g < c; g++)
            for (var f = b[3 * g + 0], h = b[3 * g + 1], u = b[3 * g + 2], k = 0; k < f; k++) e.push(new v(h, u));
        return e
    };
    ...
    var x = [
        ...
        A = "svg" === document.documentElement.tagName.toLowerCase() ? r : "undefined" == typeof CanvasRenderingContext2D ? function() {
            ...
            a.prototype.draw = function(a) {
                for (var b = this._htOption, c = this._el, e = a.getModuleCount(), g = Math.floor(b.width / e), f = Math.floor(b.height / e), h = ['<table style="border:0;border-collapse:collapse;">'], k = 0; k < e; k++) {
                    h.push("<tr>");
            ...
            function d(a, c) {
                ...
                } else !0 === b._bSupportDataURI && b._fSuccess ? b._fSuccess.call(b) : !1 === b._bSupportDataURI && b._fFail && b._fFail.call(b)
            }
    ...
    QRCode = function(a, d) {
        ...
        if (d)
            for (var b in d) this._htOption[b] = d[b];
    ...
    QRCode.prototype.makeCode = function(a) {
        var d = this._htOption.correctLevel,
            b = 1,
            c;
...
(function() {
    JSAPI = {
        ...
        gotoAuthForPc: function(l) {
            ...
            var authUrl = origin + '/login' + l;
            window.location = authUrl;
        },
        gotoAuth: function(l) {
            var authUrl = this.opt.authUrl;
            if(authUrl.substr(0, 5) == 'https') {
                authUrl = authUrl.replace('https', 'http');
                authUrl = authUrl.replace('4430', '90');
            }
            var location = (-1 != authUrl.indexOf("?")) ? authUrl + "&" + l + "&extend=" + encodeURIComponent(this.opt.extend) : authUrl + "?" + l + "&extend=" + encodeURIComponent(this.opt.extend);
